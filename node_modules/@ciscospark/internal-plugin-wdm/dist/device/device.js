  ...
  _resetLogoutTimer: function _resetLogoutTimer() {
    ...
    if (this.config.enableInactivityEnforcement && this.intranetInactivityCheckUrl && this.intranetInactivityDuration) {
      this.on('change:lastUserActivityDate', function () {
        return _this8._resetLogoutTimer();
      });

      var timer = (0, _commonTimers.safeSetTimeout)(function () {
        _this8.spark.request({
          headers: {
            'cisco-no-http-redirect': null,
            trackingid: null
          },
          method: 'GET',
          uri: _this8.intranetInactivityCheckUrl
        }).catch(function () {
          _this8.logger.info('device: did not reach internal ping endpoint; logging out after inactivity on a public network');
          return _this8.spark.logout();
        }).catch(function (reason) {
          _this8.logger.warn('device: logout failed', reason);
        });
