...
var Locus = _sparkCore.SparkPlugin.extend({
   ...
   * @returns {Promise<Types~Locus>}
   */
  updateMedia: function updateMedia(locus, _ref) {
    var sdp = _ref.sdp,
  ...
  compare: function compare(current, incoming) {
    ...
    var getEntriesFirstValue = (0, _memoize3.default)(function (locus) {
      return locus.sequence.entries.length === 0 ? 0 : (0, _first3.default)(locus.sequence.entries);
    });
    var getEntriesLastValue = (0, _memoize3.default)(function (locus) {
      return locus.sequence.entries.length === 0 ? 0 : (0, _last3.default)(locus.sequence.entries);
    });
    var getCompareFirstValue = (0, _memoize3.default)(function (locus) {
      return locus.sequence.rangeStart || getEntriesFirstValue(locus);
    });
    var getCompareLastValue = (0, _memoize3.default)(function (locus) {
    ...
    var currentOnlyEntries = (0, _difference3.default)(current.sequence.entries, incoming.sequence.entries);
    var incomingOnlyEntries = (0, _difference3.default)(incoming.sequence.entries, current.sequence.entries);
    var currentOnly = [];
    var incomingOnly = [];
