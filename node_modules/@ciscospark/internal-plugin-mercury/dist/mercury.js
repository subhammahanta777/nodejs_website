...
var Mercury = _sparkCore.SparkPlugin.extend((_dec = (0, _common.deprecated)('Mercury#listen(): Use Mercury#connect() instead'), _dec2 = (0, _common.deprecated)('Mercury#stopListening(): Use Mercury#disconnect() instead'), (_obj = {
  ...
  _prepareUrl: function _prepareUrl(webSocketUrl) {
    ...
    return this.spark.internal.feature.getFeature('developer', 'web-shared-mercury').then(function (webSharedMercury) {
  ...
  _attemptConnection: function _attemptConnection(callback) {
    ...
    _promise2.default.all([this._prepareUrl(), this.spark.credentials.getUserToken()]).then(function (_ref) {
      ...
      // NotAuthorized implies expired token
      else if (reason instanceof _errors.NotAuthorized) {
        ...
        else if (reason instanceof _errors.BadRequest || reason instanceof _errors.Forbidden) {
  ...
  _connectWithBackoff: function _connectWithBackoff() {
    ...
    return new _promise2.default(function (resolve, reject) {
      ...
      call = _backoff2.default.call(function (callback) {
        ...
        _this5._attemptConnection(callback);
      }, onComplete);
