...
var preInterceptors = ['ResponseLoggerInterceptor', 'RequestTimingInterceptor', 'RequestEventInterceptor', 'SparkTrackingIdInterceptor'];
  ...
  logout: function logout() {
    ...
    return this.config.onBeforeLogout.reverse().reduce(function (promise, _ref2) {
      var plugin = _ref2.plugin,
          fn = _ref2.fn;
      return promise.then(function () {
        return (0, _apply2.default)(fn, _this5[plugin] || _this5.internal[plugin], args);
      });
    }, _promise2.default.resolve()).then(function () {
      ...
      return (_credentials2 = _this5.credentials).invalidate.apply(_credentials2, (0, _toConsumableArray3.default)(args));
    }).then(function () {
      var _authorization;

      return _this5.authorization && _this5.authorization.logout && (_authorization = _this5.authorization).logout.apply(_authorization, (0, _toConsumableArray3.default)(args));
    }).then(function () {
